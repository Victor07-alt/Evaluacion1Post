       ...
       // valida.cuentaCanal(canal999);
        ...
        do {
            ...
            switch (opcion) {
                ...
                do {System.out.println("Ingrese informacion de Cuenta: ");
                ...
                case 3:
                    ...
                    else{System.out.println("La cantidad debe ser Mayor a la actual: ");
                    }
                    break;
                case 4:
                ...
                String newcontrasena = leer.next();
                        ...
                        else{System.out.println("Contraseña NO Valida, volviendo a Menu: ");
                        }
                    }
                    else{System.out.println("Cuenta no existe : ");}
